...
Piece is a parent of all "piece-type" objects 
(e.g. pawn, queen, knight, etc.) 
and the NullPiece.
"""
...
class Piece():
    def __init__(self, color: str, board: object, pos: list):
        ...
        Each of these attributes helps decide when and how a piece can 
        move.
            1. color
                str: "white" or "black"
            2. board
            ...
            4. moved
                bool
                This is initialized as false and is set to true when 
                the piece moves once.
                The king, rook, and pawn lose out on some movement 
                options after moving once.                
                This is the simplest way to check to see if they've 
                ever moved.
    ...
    def moves(self) -> list:
        ...
        This method returns an array containing the movement options of 
        that piece.
    ...
    def valid_moves(self) -> list:
        """
        valid_moves() takes the list of possible moves (from moves()) 
        and narrows it further.
...
class NullPiece(Piece):
    ...
    There are two reasons:
        1. The Board classes uses a 2D numpy array to keep track of its 
        board.
            The data type of things inside a numpy array must be the 
            same.
        ...
        2. It will inherit methods and attributes of Piece.
            ...
            instead of throwing an immediate error and stopping the 
            program,
            the NullPiece will simply return info the check isn't 
            looking for.
            This is opposed to checking if the piece is None each time.

    If this doesn't really make sense to you,
    and you think there are more advantages to using None instead of 
    NullPiece,
